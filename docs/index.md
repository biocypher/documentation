...
!!! tip "Featured workshop: Establishing a knowledge graph community in biomedical science"
    ...
    Join our upcoming user workshop in Heidelberg, June 15-19, 2026! Travel grants are available.
...
-   :material-graph-outline:{ .lg .middle } __BioCypher__
    ...
    [:octicons-arrow-right-24: To the BioCypher documentation](BioCypher/index.md)
...
-   :material-chat-processing-outline:{ .lg .middle } __BioChatter__
    ...
    [:octicons-arrow-right-24: To the BioChatter documentation](BioChatter/index.md)
...
-   :material-view-dashboard-edit-outline:{ .lg .middle } __Biotope__
    ...
    [:octicons-arrow-right-24: Biotope in draft stage](Biotope/index.md)
